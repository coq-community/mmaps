...
** TODO improve generic implem in Positive, AVL, RBT
** TODO args order in equal_spec vs. compare_spec
** TODO facts : from compare_spec to compare_sym, compare_trans, StrictOrder, etc
** TODO Maps as OrderedTypes ?
